...
namespace test2.Pages
{
   ...
   _danhSach = new ObservableCollection<VungTrongCompat>
          {
      new VungTrongCompat { TenVung = "Vung trong lua DBSCL", DiaDiem = "An Giang", CayTrong = "Lua" },
            new VungTrongCompat { TenVung = "Vung trong ca phe Tay Nguyen", DiaDiem = "Dak Lak", CayTrong = "Ca phe" },
  };
